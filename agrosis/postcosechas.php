            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updatecosechas['id_campania'] = $id_campania;
								$updatecosechas['fecha_inicio'] = $fechaIni;
								$updatecosechas['fecha_fin'] = $fechaFin;
								$updatecosechas['id_lote'] = $id_lote;
								$updatecosechas['id_maquinaria'] = $id_maquinaria;
								$updatecosechas['id_maquinista'] = $id_maquinista;
								$updatecosechas['rinde_ha'] = $rinde_ha;
								$updatecosechas['superficie'] = $superficie;
								$updatecosechas['id_semilla'] = $id_semilla;
								$updatecosechas['precio_hectarea'] = $precio_hectarea;
								$updatecosechas['precio_total'] = $precio_total;
								$saveupdatecosechas = $obj_cosechas->saveRecord($updatecosechas);
								
								if($saveupdatecosechas)
								{
								...
								{
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/cosechas.php">Volver</a>.</strong> </div></div>';
								}
