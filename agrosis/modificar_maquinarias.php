            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updatemaquinarias['id_maquinaria'] = $id_maquinaria;
								$updatemaquinarias['marca'] = $marca;
								$updatemaquinarias['modelo'] = $modelo;
								$updatemaquinarias['precio_hectarea'] = $precio_hectarea;
								$updatemaquinarias['descripcion'] = $descripcion;								
								$saveupdatemaquinarias = $obj_maquinarias->saveRecord($updatemaquinarias,'id_maquinaria');
								if($saveupdatemaquinarias)
								{
								...
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/maquinarias.php">Volver</a>.</strong> </div></div>';
