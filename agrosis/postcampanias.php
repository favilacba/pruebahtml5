            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updatecampanias['fecha_inicio'] = $fechaIni;
								$updatecampanias['fecha_fin'] = $fechaFin;
								$updatecampanias['id_lote'] = $id_lote;
								$updatecampanias['id_cat_semilla'] = $id_cat_semilla;
								$updatecampanias['precio_total'] = $precio_total;
								$saveupdatecampanias = $obj_campanias->saveRecord($updatecampanias);
								
								if($saveupdatecampanias)
								{
								...
								{
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/campanias.php">Volver</a>.</strong> </div></div>';
								}
