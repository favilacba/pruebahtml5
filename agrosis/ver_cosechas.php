<?php
	...
	include_once ("recupero_cosechas.php");
	...
	for($i=0;$i<$micountcosechas;$i++)
		{	
			if($id_cosecha==$cosechas[$i]['id_cosecha'])
				{
				$id_lote = $cosechas[$i]['id_lote'];
				$id_maquinista = $cosechas[$i]['id_maquinista'];
				$id_maquinaria = $cosechas[$i]['id_maquinaria'];
				$my_idcat_maquinaria=$cosechas[$i]['id_cat_maquinaria'];
				$id_insumo = $cosechas[$i]['id_insumo'];
				$my_idcat_insumo=$cosechas[$i]['id_cat_insumo'];
				$id_campania = $cosechas[$i]['id_campania'];
				}
		}
											...
											if($id_cosecha==$cosechas[$i]['id_cosecha'])
											{
												?>
													<form id="contact-form1"  method="post">
														...
														<tr>
															<td><label></label></td>
															<td><input type="text" style="display:none;" name="id_cosecha" id="id_cosecha" value="<?php echo $cosechas[$i]['id_cosecha'];?>" size="38"/></td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td><input type="text" name="fecha_inicio" id="fecha_inicio" value="<?php echo $cosechas[$i]['fecha_inicio'];?>" size="38"/></td>
														</tr>
														<tr>
															<td><label>Fecha Finalizaci&oacute;n:</label></td>
															<td><input type="text" name="fecha_fin" id="fecha_fin" value="<?php echo $cosechas[$i]['fecha_fin'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Nro. Lote:</td>
														...
														<tr>
															<td>Superficie:</td>
															<td><input type="text" name="superficie" id="superficie" value="<?php echo $cosechas[$i]['superficie'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Precio Hectarea:</td>
															<td><input type="text" name="precio_hectarea" id="precio_hectarea" value="<?php echo $cosechas[$i]['precio_hectarea'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Precio Total:</td>
															<td><input type="text" name="precio_total" id="precio_total" value="<?php echo $cosechas[$i]['precio_total'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Rendimiento Hectarea:</td>
															<td><input type="text" name="rinde_ha" id="rinde_ha" value="<?php echo $cosechas[$i]['rinde_ha'];?>" size="38"/></td>
														</tr>														
													</table>
													<div class="btns">
                        ...
                        <article class="grid_7 suffix_1 omega">
						 ...
						 <form id="form1" name="form1" method="post" action="">
						  <table width="457" border="0">
							...
							<tr>
							  <td height="23"><span class="dropcap">Cosechas: </span></td>
							  <td>&nbsp;</td>
							  <td>&nbsp;</td>
							</tr>
						  </table>
						  <table  height="111" border="1">
							...
							<?php
										 for($i=0;$i<$micountcosechas;$i++)
										{	
										echo '<tr><td>'.$cosechas[$i]['fecha_inicio'].'&nbsp;&nbsp;&nbsp;</td><td>'.$cosechas[$i]['id_lote'].'</td><td>'.$cosechas[$i]['id_semilla'].'</td><td><a href="ver_cosechas.php?id='.$cosechas[$i]['id_cosecha'].'">&nbsp;Ver&nbsp; </a></td></tr>' ;
										}
							?>   
						  </table> 
						  <p>&nbsp;</p>
