            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updatemaquinarias['fecha'] = $fechaIni;
								$updatemaquinarias['marca'] = $marca;
								$updatemaquinarias['id_cat_maquinaria'] = $id_cat_maquinaria;
								...
								$saveupdatemaquinarias = $obj_maquinarias->saveRecord($updatemaquinarias);
