            	...
            	<div class="grid_24 content-bg">
					...
					<div  style="margin-top:20px;margin-left:50px;">
                    	<article class="grid_15 suffix_1 omega">
                        	<h2>Agregar un Remito:</h2>
                            <form id="contact-form1"  method="post" action="postremitos.php">
								<table>
									<tr>
									...
									<tr>
										...
										{	
										echo '<option value="'.$insumos[$i]['id_insumo'].'">'.$insumos[$i]['nombre'].' - '.$insumos[$i]['tipo'].' - '.$insumos[$i]['marca'].'</option>' ;
										}
										?>   
											</select></td>
									</tr>
