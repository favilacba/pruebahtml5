                	...
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								...
								$updateremitos['id_insumo_semilla'] = $id_insumo;
								...
								{
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/remitosinsumos.php">Volver</a>.</strong> </div></div>';
								}
