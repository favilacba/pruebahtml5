            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updateprecipitaciones['fecha'] = $fechaIni;
								$updateprecipitaciones['id_campo'] = $id_campo;
								$updateprecipitaciones['cantidad'] = $cantidad;
								$updateprecipitaciones['descripcion'] = $descripcion;
								$saveupdateprecipitaciones = $obj_precipitaciones->saveRecord($updateprecipitaciones);
