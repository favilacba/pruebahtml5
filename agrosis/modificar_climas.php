            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updateclimas['id_clima'] = $id_clima;
								$updateclimas['superficie'] = $superficie;
								$updateclimas['descripcion'] = $descripcion;							
								$saveupdateclimas = $obj_climas->saveRecord($updateclimas,'id_clima');
								if($saveupdateclimas)
								{
								...
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/climas.php">Volver</a>.</strong> </div></div>';
