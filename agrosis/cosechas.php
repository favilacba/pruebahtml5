            	...
            	<div class="grid_24 content-bg">
					...
					<div  style="margin-top:20px;margin-left:50px;">
                    	<article class="grid_15 suffix_1 omega">
                        	<h2>Agregar una Cosecha</h2>
                            <form id="contact-form1"  method="post" action="postcosechas.php">
								<table>
								    <tr>
									...
									<tr>
										...
										{	
										echo '<option value="'.$semillas[$i]['id_semilla'].'">'.$semillas[$i]['id_cat_semilla'].' - '.$semillas[$i]['variedad'].'</option>' ;
										}
										?>   
											</select></td>
									</tr>
									...
									<tr>
										...
										<td><input type="text" name="rinde_ha" id="rinde_ha" size="38"/></td>
									</tr>
