            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updatesiembras['id_campania'] = $id_campania;
								$updatesiembras['fecha_inicio'] = $fechaIni;
								$updatesiembras['fecha_fin'] = $fechaFin;
								$updatesiembras['id_lote'] = $id_lote;
								$updatesiembras['id_maquinaria'] = $id_maquinaria;
								$updatesiembras['id_maquinista'] = $id_maquinista;
								$updatesiembras['id_semilla'] = $id_semilla;
								$updatesiembras['superficie'] = $superficie;
								$updatesiembras['cant_semillas'] = $cant_semillas;
								$updatesiembras['precio_hectarea'] = $precio_hectarea;
								$updatesiembras['precio_total'] = $precio_total;
								$saveupdatesiembras = $obj_siembras->saveRecord($updatesiembras);
								
								if($saveupdatesiembras)
								{
								...
								{
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/siembras.html">Volver</a>.</strong> </div></div>';
								}
