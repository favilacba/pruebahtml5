            	...
            	<div class="grid_24 content-bg">
					...
					<div  style="margin-top:20px;margin-left:50px;">
                    	<article class="grid_15 suffix_1 omega">
                        	<h2>Eliminar maquinarias </h2>
							<?php
							$id_maquinaria = $_GET["id"];
							include('include/abrirconexion.php');  
							$tabla_db1="as_maquinarias";
							$query = "delete from $tabla_db1 where id_maquinaria = '$id_maquinaria'"; 
						 ...
						 <form id="form1" name="form1" method="post" action="">
						  ...
						  <tr>
							...
							<?php
										...
										{	
										echo '<tr><td>'.$maquinarias[$i]['tipo'].'&nbsp;</td><td>'.$maquinarias[$i]['marca'].'</td><td><a href="ver_maquinarias.php?id='.$maquinarias[$i]['id_maquinaria'].'">&nbsp;Ver&nbsp; </a></td><td><a href="eliminar_maquinarias.php?id='.$maquinarias[$i]['id_maquinaria'].'">&nbsp;Eliminar&nbsp; </a></td></tr>' ;
										}
							?>   
						  </table>
						  <p>&nbsp;</p>
