            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updatedesmalezados['id_campania'] = $id_campania;
								$updatedesmalezados['fecha_inicio'] = $fechaIni;
								$updatedesmalezados['fecha_fin'] = $fechaFin;
								$updatedesmalezados['id_lote'] = $id_lote;
								$updatedesmalezados['id_maquinaria'] = $id_maquinaria;
								$updatedesmalezados['id_maquinista'] = $id_maquinista;
								$updatedesmalezados['descripcion'] = $descripcion;
								$updatedesmalezados['cant_hectareas'] = $cant_hectareas;
								$updatedesmalezados['precio_hectarea'] = $precio_hectarea;
								$updatedesmalezados['precio_total'] = $precio_total;
								$saveupdatedesmalezados = $obj_desmalezados->saveRecord($updatedesmalezados);
								
								if($saveupdatedesmalezados)
								{
								...
								{
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/desmalezados.php">Volver</a>.</strong> </div></div>';
								}
