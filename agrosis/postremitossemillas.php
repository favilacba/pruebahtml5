            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updateremitos['fecha'] = $fecha;
								$updateremitos['id_proveedor'] = $id_proveedor;
								$updateremitos['numero_remito'] = $numero_remito;
								$updateremitos['id_insumo_semilla'] = $id_semilla;
								$updateremitos['cantidad'] = $cantidad;
								$updateremitos['precio'] = $precio;
								$updateremitos['precio_total'] = $precio_total;
								$updateremitos['id_cuenta'] = $id_cuenta;
								$saveupdateremitos = $obj_remitos->saveRecord($updateremitos);
								
								if($saveupdateremitos)
								{
								...
								{
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/remitossemillas.php">Volver</a>.</strong> </div></div>';
								}
