            	...
            	<div class="grid_24 content-bg">
					...
					<div  style="margin-top:20px;margin-left:50px;">
                    	<article class="grid_15 suffix_1 omega">
                        	<h2>Agregar una Fertilizaci&oacute;n</h2>
                            <form id="contact-form1"  method="post" action="postfertilizaciones.php">
								<table>
								    <tr>
									...
									<tr>
										...
										{	
										echo '<option value="'.$insumos[$i]['id_insumo'].'">'.$insumos[$i]['nombre'].' - '.$insumos[$i]['id_cat_insumo'].' - '.$insumos[$i]['marca'].'</option>' ;
										}
										?>   
											</select></td>
									</tr>
