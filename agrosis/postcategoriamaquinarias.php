<?php
	...
	$obj_cat_maquinarias = new baseMysql('as_cat_maquinarias');
	?>
            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updatecat_maquinarias['descripcion'] = $descripcion;
								$saveupdatecat_maquinarias= $obj_cat_maquinarias->saveRecord($updatecat_maquinarias);
								if($saveupdatecat_maquinarias)
								{
								echo ' <div class="inner-1"><div class="success"> Datos ingresados correctamente!. <strong> <p>Muchas gracias.</strong> </div></div>';
								}
								else
								{
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/categoria_maquinarias.php">Volver</a>.</strong> </div></div>';
								}
