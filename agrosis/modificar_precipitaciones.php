            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updateprecipitaciones['id_precipitacion'] = $id_precipitacion;
								$updateprecipitaciones['cantidad'] = $cantidad;
								$updateprecipitaciones['descripcion'] = $descripcion;				
								$saveupdateprecipitaciones = $obj_precipitaciones->saveRecord($updateprecipitaciones,'id_precipitacion');
								if($saveupdateprecipitaciones)
								{
								...
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/precipitaciones.php">Volver</a>.</strong> </div></div>';
