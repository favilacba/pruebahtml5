            	...
            	<div class="grid_24 content-bg">
					...
					<div  style="margin-top:20px;margin-left:50px;">
                    	<article class="grid_15 suffix_1 omega">
                        	<h2>Ver o Modificar maquinistas </h2>
							<?php
							 for($i=0;$i<$micountmaquinistas;$i++)
										{	
											if($id_maquinista==$maquinistas[$i]['id_maquinista'])
											{
												?>
														<form id="contact-form1"  method="post" action="modificar_maquinistas.php">
														<table>
														<tr>
															<td><label></label></td>
															<td><input type="text" style="display:none;" name="id_maquinista" id="id_maquinista" value="<?php echo $maquinistas[$i]['id_maquinista'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Nombre:</td>
															<td><input type="text" name="nombre" id="nombre" value="<?php echo $maquinistas[$i]['nombre'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>DNI:</td>
															<td><input type="text" name="dni" id="dni" value="<?php echo $maquinistas[$i]['dni'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Provincia:</td>
															<td><input type="text" name="provincia" id="provincia" value="<?php echo $maquinistas[$i]['provincia'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Ciudad:</td>
															<td><input type="text" name="ciudad" id="ciudad" value="<?php echo $maquinistas[$i]['ciudad'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Domicilio:</td>
															<td><input type="text" name="domicilio" id="domicilio" value="<?php echo $maquinistas[$i]['domicilio'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Telefono:</td>
															<td><input type="text" name="telefono" id="telefono" value="<?php echo $maquinistas[$i]['telefono'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Celular:</td>
															<td><input type="text" name="celular" id="celular" value="<?php echo $maquinistas[$i]['celular'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>E-mail:</td>
															<td><input type="text" name="mail" id="mail" value="<?php echo $maquinistas[$i]['mail'];?>" size="38"/></td>
														</tr>																	
													</table>
													<div class="btns">
