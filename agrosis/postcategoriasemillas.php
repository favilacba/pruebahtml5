<?php
	...
	$obj_cat_semillas = new baseMysql('as_cat_semillas');
	?>
            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updatecat_semillas['descripcion'] = $descripcion;
								$saveupdatecat_semillas= $obj_cat_semillas->saveRecord($updatecat_semillas);
								if($saveupdatecat_semillas)
								{
								echo ' <div class="inner-1"><div class="success"> Datos ingresados correctamente!. <strong> <p>Muchas gracias.</strong> </div></div>';
								}
								else
								{
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/categoria_semillas.php">Volver</a>.</strong> </div></div>';
								}
