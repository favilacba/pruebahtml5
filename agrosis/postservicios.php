<?php
	...
	$obj_servicios = new baseMysql('as_servicios');
	?>
                	...
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								...
								$updateservicios['fecha_inicio'] = $fecha_inicio;
								$updateservicios['fecha_fin'] = $fecha_fin;
								$updateservicios['id_lote'] = $id_lote;
								$updateservicios['id_cultivo'] = $id_cultivo;
								$updateservicios['precio_total'] = $precio_total;
								$saveupdateservicios = $obj_servicios->saveRecord($updateservicios);
								
								if($saveupdateservicios)
								{
								...
								{
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/servicios.php">Volver</a>.</strong> </div></div>';
								}
