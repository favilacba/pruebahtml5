                	...
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								...
								$updateclimas['fecha'] = $fechaIni;
								$updateclimas['id_campo'] = $id_campo;
								$updateclimas['id_cat_clima'] = $id_cat_clima;
								$updateclimas['id_lote'] = $id_lote;
								$updateclimas['descripcion'] = $descripcion;
								$updateclimas['superficie'] = $superficie;
								$saveupdateclimas = $obj_climas->saveRecord($updateclimas);
