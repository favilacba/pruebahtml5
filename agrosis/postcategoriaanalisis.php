<?php
	...
	$obj_cat_analisis = new baseMysql('as_cat_analisis');
	?>
            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updatecat_analisis['descripcion'] = $descripcion;
								$saveupdatecat_analisis= $obj_cat_analisis->saveRecord($updatecat_analisis);
								if($saveupdatecat_analisis)
								{
								echo ' <div class="inner-1"><div class="success"> Datos ingresados correctamente!. <strong> <p>Muchas gracias.</strong> </div></div>';
								}
								else
								{
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/categoria_analisis.php">Volver</a>.</strong> </div></div>';
								}
