            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updatelotes['id_lote'] = $id_lote;
								$updatelotes['ubicacion'] = $ubicacion;
								$updatelotes['numero_lote'] = $numero_lote;
								$updatelotes['superficie'] = $superficie;
								$updatelotes['descripcion'] = $descripcion;							
								$saveupdatelotes = $obj_lotes->saveRecord($updatelotes,'id_lote');
								if($saveupdatelotes)
								{
								...
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/lotes.php">Volver</a>.</strong> </div></div>';
