<?php
	...
	for($i=0;$i<$micountfumigaciones;$i++)
		{	
			if($id_fumigacion==$fumigaciones[$i]['id_fumigacion'])
				{
				$id_lote = $fumigaciones[$i]['id_lote'];
				$id_maquinista = $fumigaciones[$i]['id_maquinista'];
				$id_maquinaria = $fumigaciones[$i]['id_maquinaria'];
				$my_idcat_maquinaria=$fumigaciones[$i]['id_cat_maquinaria'];
				$id_insumo = $fumigaciones[$i]['id_insumo'];
				$my_idcat_insumo=$fumigaciones[$i]['id_cat_insumo'];
				$id_campania = $fumigaciones[$i]['id_campania'];
				}
		}
											...
											if($id_fumigacion==$fumigaciones[$i]['id_fumigacion'])
											{
												?>
													<form id="contact-form1"  method="post">
														...
														<tr>
															<td><label></label></td>
															<td><input type="text" style="display:none;" name="id_fumigacion" id="id_fumigacion" value="<?php echo $fumigaciones[$i]['id_fumigacion'];?>" size="38"/></td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td><input type="text" name="fecha_inicio" id="fecha_inicio" value="<?php echo $fumigaciones[$i]['fecha_inicio'];?>" size="38"/></td>
														</tr>
														<tr>
															<td><label>Fecha Finalizaci&oacute;n:</label></td>
															<td><input type="text" name="fecha_fin" id="fecha_fin" value="<?php echo $fumigaciones[$i]['fecha_fin'];?>" size="38"/></td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td><input type="text" name="cant_hectareas" id="cant_hectareas" value="<?php echo $fumigaciones[$i]['cant_hectareas'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Precio Hectarea:</td>
															<td><input type="text" name="precio_hectarea" id="precio_hectarea" value="<?php echo $fumigaciones[$i]['precio_hectarea'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Precio Total:</td>
															<td><input type="text" name="precio_total" id="precio_total" value="<?php echo $fumigaciones[$i]['precio_total'];?>" size="38"/></td>
														</tr>														
													</table>
													<div class="btns">
						 ...
						 <form id="form1" name="form1" method="post" action="">
						  ...
						  <table  height="111" border="1">
							...
							<?php
										 for($i=0;$i<$micountfumigaciones;$i++)
										{	
										echo '<tr><td>'.$fumigaciones[$i]['fecha_inicio'].'&nbsp;&nbsp;&nbsp;</td><td>'.$fumigaciones[$i]['id_lote'].'</td><td>'.$fumigaciones[$i]['id_insumo'].'</td><td><a href="ver_fumigaciones.php?id='.$fumigaciones[$i]['id_fumigacion'].'">&nbsp;Ver&nbsp; </a></td></tr>' ;
										}
							?>   
						  </table> 
						  </table>
