<?php
	...
	$obj_cat_climas = new baseMysql('as_cat_climas');
	?>
            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updatecat_climas['descripcion'] = $descripcion;
								$saveupdatecat_climas= $obj_cat_climas->saveRecord($updatecat_climas);
								if($saveupdatecat_climas)
								{
								echo ' <div class="inner-1"><div class="success"> Datos ingresados correctamente!. <strong> <p>Muchas gracias.</strong> </div></div>';
								}
								else
								{
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/categoria_climas.php">Volver</a>.</strong> </div></div>';
								}
