            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updatefertilizaciones['id_campania'] = $id_campania;
								$updatefertilizaciones['fecha_inicio'] = $fechaIni;
								$updatefertilizaciones['fecha_fin'] = $fechaFin;
								$updatefertilizaciones['id_lote'] = $id_lote;
								$updatefertilizaciones['id_maquinaria'] = $id_maquinaria;
								$updatefertilizaciones['id_maquinista'] = $id_maquinista;
								$updatefertilizaciones['id_insumo'] = $id_insumo;
								$updatefertilizaciones['cant_hectareas'] = $cant_hectareas;
								$updatefertilizaciones['cant_insumos'] = $cant_insumos;
								$updatefertilizaciones['precio_hectarea'] = $precio_hectarea;
								$updatefertilizaciones['precio_total'] = $precio_total;
								$saveupdatefertilizaciones = $obj_fertilizaciones->saveRecord($updatefertilizaciones);
								
								if($saveupdatefertilizaciones)
								{
								...
								{
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/fertilizaciones.php">Volver</a>.</strong> </div></div>';
								}
