<?php
	...
	$obj_cat_insumos = new baseMysql('as_cat_insumos');
	?>
            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updatecat_insumos['descripcion'] = $descripcion;
								$saveupdatecat_insumos= $obj_cat_insumos->saveRecord($updatecat_insumos);
								if($saveupdatecat_insumos)
								{
								echo ' <div class="inner-1"><div class="success"> Datos ingresados correctamente!. <strong> <p>Muchas gracias.</strong> </div></div>';
								}
								else
								{
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/categoria_insumos.php">Volver</a>.</strong> </div></div>';
								}
