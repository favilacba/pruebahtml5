            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updateinsumos['nombre'] = $nombre;
								$updateinsumos['id_proveedor'] = $id_proveedor;
								$updateinsumos['id_cat_insumo'] = $id_cat_insumo;
								$updateinsumos['marca'] = $marca;
								$updateinsumos['cantidad'] = $cantidad;
								$updateinsumos['precio'] = $precio;
								$updateinsumos['descripcion'] = $descripcion;
								$saveupdateinsumos = $obj_insumos->saveRecord($updateinsumos);
								if($saveupdateinsumos)
								{
								...
								{
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/insumos.php">Volver</a>.</strong> </div></div>';
								}
