            	...
            	<div class="grid_24 content-bg">
					...
					<div  style="margin-top:20px;margin-left:50px;">
                    	<article class="grid_15 suffix_1 omega">
                        	<h2>Agregar una Siembra</h2>
                            <form id="contact-form1"  method="post" action="postsiembras.php">
								<table>
								    <tr>
									...
									<tr>
										<td>Cant. Semillas:</td>
										<td><input type="text" name="cant_semillas" id="cant_semillas" size="38"/></td>
									</tr>
									<tr>
										<td>Maquinaria:</td>
                        ...
                        <article class="grid_7 suffix_1 omega">05/05/2010 Soja 2154 Lote 17
