            	...
            	<div class="grid_24 content-bg">
					...
					<div  style="margin-top:20px;margin-left:50px;">
                    	<article class="grid_15 suffix_1 omega">
                        	<h2>Ver o Modificar Laboratorios </h2>
							<?php
							 for($i=0;$i<$micountlaboratorios;$i++)
										{	
											if($id_laboratorio==$laboratorios[$i]['id_laboratorio'])
											{
												?>
														<form id="contact-form1"  method="post" action="postmodificarlaboratorios.php">
														<table>
														<tr>
															<td><label></label></td>
															<td><input type="text" style="display:none;" name="id_laboratorio" id="id_laboratorio" value="<?php echo $laboratorios[$i]['id_laboratorio'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Nombre:</td>
															<td><input type="text" name="nombre" id="nombre" value="<?php echo $laboratorios[$i]['nombre'];?>"size="38"/></td>
														</tr>
														<tr>
															<td>Telefono:</td>
															<td><input type="text" name="telefono" id="telefono" value="<?php echo $laboratorios[$i]['telefono'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Provincia:</td>
															<td><input type="text" name="provincia" id="provincia" value="<?php echo $laboratorios[$i]['provincia'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Ciudad:</td>
															<td><input type="text" name="ciudad" id="ciudad" value="<?php echo $laboratorios[$i]['ciudad'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Domicilio:</td>
															<td><input type="text" name="domicilio" id="domicilio" value="<?php echo $laboratorios[$i]['domicilio'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>E-mail:</td>
															<td><input type="text" name="mail" id="mail" value="<?php echo $laboratorios[$i]['mail'];?>" size="38"/></td>
														</tr>
