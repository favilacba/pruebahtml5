            	...
            	<div class="grid_24 content-bg">
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								extract($_POST);
								$updateanalisis['id_campania'] = $id_campania;
								$updateanalisis['fecha'] = $fechaIni;
								$updateanalisis['id_responsable'] = $id_responsable;
								$updateanalisis['tipo'] = $tipo;
								$updateanalisis['id_laboratorio'] = $id_laboratorio;
								$updateanalisis['descripcion'] = $descripcion;
								$saveupdateanalisis = $obj_analisis->saveRecord($updateanalisis);
								
								if($saveupdateanalisis)
								{
								...
								{
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/analisis.php">Volver</a>.</strong> </div></div>';
								}
