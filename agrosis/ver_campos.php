            	...
            	<div class="grid_24 content-bg">
					...
					<div  style="margin-top:20px;margin-left:50px;">
                    	<article class="grid_15 suffix_1 omega">
                        	<h2>Ver o Modificar campos </h2>
							<?php
							 for($i=0;$i<$micount;$i++)
										{	
											if($id_campo==$campos[$i]['id_campo'])
											{
												?>
														<form id="contact-form1"  method="post" action="modificar_campos.php">
														<table>
														<tr>
															<td><label></label></td>
															<td><input type="text" style="display:none;" name="id_campo" id="id_campo" value="<?php echo $campos[$i]['id_campo'];?>" size="38"/></td>
														</tr>
														<tr>
															<td><label>Fecha:</label></td>
															<td><input type="text" name="fecha" id="fecha" value="<?php echo $campos[$i]['fecha'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Nombre:</td>
															<td><input type="text" name="nombre" id="nombre" value="<?php echo $campos[$i]['nombre'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Ubicaci&oacute;n:</td>
															<td><input type="text" name="ubicacion" id="ubicacion" value="<?php echo $campos[$i]['ubicacion'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Provincia:</td>
															<td><input type="text" name="provincia" id="provincia" value="<?php echo $campos[$i]['provincia'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Ciudad:</td>
															<td><input type="text" name="ciudad" id="ciudad" value="<?php echo $campos[$i]['ciudad'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Departamento:</td>
															<td><input type="text" name="dpto" id="dpto" value="<?php echo $campos[$i]['dpto'];?>" size="38"/></td>
														</tr>
														<tr><td>Descripci&oacute;n:</td>
															<td><textarea name="descripcion" id="descripcion" cols="45" rows="5"><?php echo $campos[$i]['descripcion'];?></textarea>
														</tr>																	
													</table>
													<div class="btns">
