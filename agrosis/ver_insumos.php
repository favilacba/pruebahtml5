<?php
	...
	for($i=0;$i<$micountinsumos;$i++)
		{	
			if($id_insumo==$insumos[$i]['id_insumo'])
				{
				$my_id_proveedor=$insumos[$i]['id_proveedor'];
				$my_id_cat_insumo=$insumos[$i]['id_cat_insumo'];
				}
		}
	...
	for($l=0;$l<$micountcatinsumos;$l++)
		{	
			if($my_id_cat_insumo==$catinsumos[$l]['id_cat_insumo'])
				{
											...
											if($id_insumo==$insumos[$i]['id_insumo'])
											{
												?>
													<form id="contact-form1"  method="post" action="modificar_climas.php">
														...
														<tr>
															<td><label></label></td>
															<td><input type="text" style="display:none;" name="id_insumo" id="id_insumo" value="<?php echo $insumos[$i]['id_insumo'];?>" size="38"/></td>
														</tr>
														<tr>
															<td><label>Nombre:</label></td>
															<td><input type="text" name="nombre" id="nombre" value="<?php echo $insumos[$i]['nombre'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Marca:</td>
															<td><input type="text" name="marca" id="marca" value="<?php echo $insumos[$i]['marca'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Categor&iacute;a:</td>
															<td><input type="text" name="my_cat_insumo" id="my_cat_insumo" value="<?php echo $my_categoria_insumo;?>" size="38"/></td>
														</tr>
														<tr>
															<td>Cantidad:</td>
															<td><input type="text" name="cantidad" id="cantidad" value="<?php echo $insumos[$i]['cantidad'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Precio:</td>
															<td><input type="text" name="precio" id="precio" value="<?php echo $insumos[$i]['precio'];?>" size="38"/></td>
														</tr>
														<tr>
															<td>Proveedor:</td>
														...
														<tr><td>Descripci&oacute;n:</td>
															<td><textarea name="descripcion" id="descripcion" cols="45" rows="5"><?php echo $insumos[$i]['descripcion'];?></textarea>
														</tr>														
													</table>
													<div class="btns">
