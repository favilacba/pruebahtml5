                	...
                	<div class="wrapper">
                    	<article class="grid_6 suffix_1 prefix_1 alpha">
                        	<?php 
								...
								$saveupdatecuentas = $obj_cuentas->saveRecord($updatecuentas);
								...
								{
								echo ' <div class="inner-1"><div class="success"> Error en los datos!. <strong> <p><a href="http://www.fabioavila.com.ar/agrosis/cuentas.html">Volver</a>.</strong> </div></div>';
								}
